...
public class PayFortPayment {
    ...
    //Statics
    //Pulled from Cred java file
    public final static String MERCHANT_IDENTIFIER = Cred.getMI();
    public final static String ACCESS_CODE = Cred.getAC() ;
    public final static String SHA_REQUEST_PHRASE = Cred.getSReqP();
    public final static String SHA_RESPONSE_PHRASE = Cred.getSResP();
